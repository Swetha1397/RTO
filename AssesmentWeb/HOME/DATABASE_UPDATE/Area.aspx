                ...
                <div style="width: 80%;">
                    <table align="center">
                        <tr>
                            <td colspan="2">
                                <p align="center">
                                    <asp:Label ID="LblInfoArea" runat="server" Text="ADD AREA" CssClass="lbl"></asp:Label>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlDistrict" runat="server"  AutoPostBack="true"
                                 OnSelectedIndexChanged="DropDownListDistrict_SelectedIndexChanged" AppendDataBoundItems="true" >
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCity" runat="server"  AutoPostBack="true"
                                 OnSelectedIndexChanged="DropDownListCity_SelectedIndexChanged" AppendDataBoundItems="true" >
                        ...
                        <tr>
                            <%--changes: CityId changed to AreaId in txtbox and label Id 15/10/21--%>
                            <td>
