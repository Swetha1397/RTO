        ...
        <div>
            <table align="center">
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="PLEASE ENTER RTO NUMBER" ControlToValidate="txtRTONo"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="PASSWORD IS EMPTY!!" ControlToValidate="txtPassword"></asp:RequiredFieldValidator>
